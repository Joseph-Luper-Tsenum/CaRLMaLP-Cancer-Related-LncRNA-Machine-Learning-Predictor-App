        ...
        ui.nav(
            ...
            ui.layout_sidebar(
                ui.panel_sidebar(
                    ...
                    ui.tags.br(),
                    ui.tags.br(),
                    ui.p("""There is an example input feature file to download."""
                    ),
                    ui.download_button("download1","Example File")
                ),
                ui.panel_main(
                    ui.navset_tab(
                        # ui.nav(
                        ...
                        ui.nav(
                            ...
                            ui.panel_sidebar(
                                ui.p("""Download Your Prediction to csv"""),
...
def server(input: Inputs, output: Outputs, session: Session):
    ...
    def download2():
        df = run_ML_pipeline('prediction_result', input)
